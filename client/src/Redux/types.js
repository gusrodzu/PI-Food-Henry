// //Definimos las acciones o eventos que pueden suceder 
// en nuestra aplicación y que modificarán el estado de la misma. 
...
export const ADD_RECIPE_DETAIL_ERROR = "ADD_RECIPE_DETAIL_ERROR";
